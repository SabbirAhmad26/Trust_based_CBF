function score = ConstraintTest(simindex,que,table,ego,trust_thereshold)
%CONSTRAINTTEST Summary of this function goes here
%   Detailed explanation goes here
MultipleConstraints = 0;
[ip, index, position] = search_for_conflictCAVS_trustversion(que,table, ego,MultipleConstraints,trust_thereshold);
thereshold = -5;
if simindex == 80
    stop = 1;
end
